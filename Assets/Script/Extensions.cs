...
{
	public static void SetPositionX(this Transform currentTransform, float newX)
	{
		currentTransform.position = new Vector3(newX, currentTransform.position.y, currentTransform.position.z);
	}
